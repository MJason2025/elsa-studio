...
public class DefaultActivityDisplaySettingsProvider : IActivityDisplaySettingsProvider
{
    ...
    public IDictionary<string, ActivityDisplaySettings> GetSettings() => new Dictionary<string, ActivityDisplaySettings>
    {
        ...
        //Custom Activities
        ["Elsa.CustomActivities.Activities.PrintMessage"] = new(DefaultActivityColors.CustomActivities, ElsaStudioIcons.Heroicons.ArrowDownLeft),
        ["Elsa.CustomActivities.Activities.SimpleEvent"] = new(DefaultActivityColors.Primitives, ElsaStudioIcons.Heroicons.Link),
        ["Elsa.CustomActivities.Activities.SelectItemListActivity"] = new(DefaultActivityColors.Timer, ElsaStudioIcons.Heroicons.Send),
        ["Elsa.CustomActivities.Activities.RandomNumberActivity"] = new(DefaultActivityColors.CustomActivities, ElsaStudioIcons.Heroicons.Launch),
